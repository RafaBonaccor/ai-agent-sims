...
export class AgentWorld {
  ...
  triggerIntent(intentId, network, options = {}) {
    ...
    const assignments = {
      ...
      "memory-sync": [
        ["orchestrator", "meeting", "moderating council"],
        ["memory", "meeting", "recalling context"],
        ["scheduler", "meeting", "aligning timing"],
        ["planner", "meeting", "advising"],
        ["researcher", "meeting", "advising"],
        ["builder", "meeting", "advising"],
        ["critic", "meeting", "advising"],
      ],
      schedule: [
